...
export function Contact() {
  ...
  const contactInfo = [
    { icon: Mail, label: "Email", value: "nikhileswarb7@gmail.com" },
    { icon: Phone, label: "Phone", value: "+91 7684023522" },
    { icon: MapPin, label: "Location", value: "Visakhapatnam, Andhra Pradesh, India" },
  ];

  const quickLinks = [
    { icon: Github, url: "https://github.com/nikhileswarb7-dotcom" },
    { icon: Linkedin, url: "https://www.linkedin.com/in/nikhileswar-behera" },
    { icon: Mail, url: "mailto:nikhileswarb7@gmail.com" },
    { icon: MessageCircle, url: "https://wa.me/917684023522" },
  ];
              ...
              {contactInfo.map((item, index) => (
                ...
                >
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-gray-900 dark:text-white break-all">{item.value}</p>
                  </div>
                </motion.div>
              ))}
            </div>
